                                ...
                                <asp:Repeater ID="AuctionItemsDataTable" runat="server">
                                    <ItemTemplate>
                                        <tr class="hover:bg-purple-100 transition-all">
                                            ...
                                            <td class="py-2 px-4 border-b">
                                                <asp:LinkButton ID="btnDelete" runat="server" CommandArgument='<%# Eval("AuctionItemId") %>' OnClientClick="return confirm('Are you sure you want to delete this record?');" OnClick="DeleteRecord" CssClass="text-red-500 hover:text-red-600">Delete</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
